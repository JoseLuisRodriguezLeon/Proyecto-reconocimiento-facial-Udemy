...
#NO CONFUNDIR LISTAS CON CONJUNTOS
# Listas: [] permiten elementos duplicados, ordenados y modificables
# Conjuntos: {} no permiten elementos duplicados, no ordenados y no indexados
# También existen las tuplas: () no permiten modificaciones (inmutables)
